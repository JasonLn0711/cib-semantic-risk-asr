...
- The selected-300 human risk-atom audit queue now lives at
  ...
  present. The aggregate reviewer action checklist is generated by
  `80_semantic_risk_asr/annotation/build_human_audit_reviewer_action_checklist.py`;
  current checklist status is `reviewer_action_ready`, with `6/6` packet rows
  and `18/18` model assessments still pending in the ignored local response TSV.
  The strict

...
- Current state:
  ...
  現在是 `ok=true`、`23/23` checks passing、`failed_checks=[]`。
...
- Current state:
  ...
  `ok=true`、`23/23` checks passing、`failed_checks=[]`。
...
- Current state:
  ...
  `response_complete_ready_to_write`；consistency 現在是 `ok=true`、`23/23`
...
- Current state:
  consistency 現在是 `ok=true`、`23/23` checks passing、`failed_checks=[]`。

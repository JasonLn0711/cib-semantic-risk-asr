#!/usr/bin/env python3
"""Validate aggregate-only MiniCPM-o 4.5 sentinel-control records."""
...
RUN_DIR = Path("70_experiments/runs/v2_0_multimodal_batch1_minicpm_o_4_5_sentinel_controls_2026_06_01")
...
def main() -> int:
    ...
    print(f"minicpm_o_4_5_sentinel_controls_record_ok {args.run_dir}")
    return 0
